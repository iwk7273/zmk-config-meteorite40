...
- 現行 manifest は `iwk7273/zmk#feat/meteorite-custom-config-rpc`、`iwk7273/zmk-feature-meteorite-config#feat/prospector-support`、`iwk7273/prospector-zmk-module#main` を参照します。
